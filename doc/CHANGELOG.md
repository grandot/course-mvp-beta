...
### Added
- 意圖識別準確率修復（AI 信心閾值 0.3→0.7，啟用規則兜底，非課程語句防呆） (2025-08-11)
- 啟用 IntentRouter 分層架構（parseIntent 專注識別，補問邏輯由 Router 處理） (2025-08-11)
- 測試模式安全機制（開發環境可跳過 LINE 簽名驗證） (2025-08-11)
 - 自動歸檔（狀態板 Done 溢出）
