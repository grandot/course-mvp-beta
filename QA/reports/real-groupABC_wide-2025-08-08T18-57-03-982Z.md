...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754678829098",
...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754678864357",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  ...
  - systemBehavior:
    ...
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🔍 檢查 replyToken: test-reply-token-1754678893980",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754678971795",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  ...
  - taskExecution:
    ...
    - "message": "📤 [測試模式] 實際業務回覆: ❓ 請提供以下資訊：課程日期",
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754678988710",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679034079",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
    - "message": "📤 [測試模式] 實際業務回覆: 處理訊息時發生錯誤，請稍後再試。",
...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679049153",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
    - "message": "📤 [測試模式] 實際業務回覆: 處理訊息時發生錯誤，請稍後再試。",
...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679086711",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679102301",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
    - "message": "📤 [測試模式] 實際業務回覆: 處理訊息時發生錯誤，請稍後再試。",
...
- 診斷：
  - taskExecution:
    - "message": "📊 任務執行結果: {",
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679174877",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  ...
  - taskExecution:
    ...
    - "message": "📊 任務執行結果: {",
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679201452",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  - taskExecution:
    ...
    - "message": "📊 任務執行結果: {",
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679218215",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  - taskExecution:
    ...
    - "message": "📊 任務執行結果: {",
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679258720",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
    - "message": "📤 [測試模式] 實際業務回覆: ✅ 課程內容已成功記錄！",
...
- 診斷：
  - taskExecution:
    - "message": "📊 任務執行結果: {",
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679312165",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  - taskExecution:
    ...
    - "message": "📤 [測試模式] 實際業務回覆: ✅ 課程已安排成功！",
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679329247",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679346178",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  ...
  - errors:
    - "message": "⚠️ 無待處理的意圖資料",
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679362366",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
...
- 診斷：
  ...
  - errors:
    - "message": "⚠️ 無待處理的意圖資料",
  - systemBehavior:
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679381158",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
    - "message": "📤 [測試模式] 實際業務回覆: 請問是要取消哪個範圍？",
...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679398068",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
    - "message": "📤 [測試模式] 實際業務回覆: 處理訊息時發生錯誤，請稍後再試。",
...
- 診斷：
  ...
  - systemBehavior:
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🚀 生產用戶，使用真實 LINE Service",
    - "message": "🔍 檢查 replyToken: test-reply-token-1754679413677",
    - "message": "🧪 檢測到測試 token，跳過真實 LINE API 調用",
    - "message": "📤 [測試模式] 實際業務回覆: 處理訊息時發生錯誤，請稍後再試。",
